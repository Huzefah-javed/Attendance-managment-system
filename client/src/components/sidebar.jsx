  ...
  return (
    <>
      ...
      <button
        ...
        aria-expanded={open}
        onClick={toggle}
        className="fixed left-4 top-4 z-50 inline-flex items-center justify-center rounded-full bg-brand bg-blue-800 text-white text-brand-foreground p-3 shadow-lg shadow-brand/30 transition hover:brightness-105 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 ring-offset-background"
      >
        {open ? (
